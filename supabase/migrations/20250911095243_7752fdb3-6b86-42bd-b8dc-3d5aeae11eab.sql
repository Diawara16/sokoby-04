-- Add new columns to store_settings for enhanced customization
ALTER TABLE public.store_settings 
ADD COLUMN about_text TEXT,
ADD COLUMN banner_url TEXT,
ADD COLUMN enabled_languages TEXT[] DEFAULT ARRAY['fr']::TEXT[],
ADD COLUMN default_language TEXT DEFAULT 'fr';
