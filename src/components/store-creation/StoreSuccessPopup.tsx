    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="sm:max-w-[250px] w-[80%] bg-white rounded-xl shadow-lg p-0 border-0 max-h-[90vh] overflow-y-auto">
        <div className="p-5 text-center space-y-4">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              {isAI ? (
                <>
                  ...
                  <br />
                  Ce processus prend <strong>1–3 minutes</strong>.<br />
          ...
          {isAI && <div className="text-xs text-gray-500 italic min-h-[20px] animate-pulse">{steps[currentStep]}</div>}
          ...
          <div className="space-y-2 w-full pt-1">
            <Button
              ...
              className="w-full bg-primary hover:bg-primary/90 text-white py-4 rounded-lg transition text-sm font-medium"
            >
            ...
            <Button
              ...
              className="w-full text-gray-500 hover:text-gray-700 transition text-xs"
            >
