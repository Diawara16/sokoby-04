  ...
  const monthlyPlans = [
    {
      ...
      features: [
        "Jusqu'à 2 boutiques en ligne",
        "Jusqu'à 100 produits par boutique",
        "2 Go de stockage photos par boutique",
        "Gestion des éléments de marque basique",
        "Support par email",
        "Analytics de base",
        "Thèmes standards",
        "Paiements sécurisés",
        "Domaine personnalisé pour chaque boutique",
      ],
      trial: true,
    },
    {
      ...
      features: [
        "Jusqu'à 5 boutiques en ligne",
        "Produits illimités par boutique",
        "10 Go de stockage photos par boutique",
    ...
    },
    {
      ...
      features: [
        "Jusqu'à 8 boutiques en ligne",
        "Produits illimités par boutique",
        "Stockage illimité par boutique",
        ...
        "Console d'administration multi-boutiques avancée",
      ],
      trial: true,
    },
  ];
